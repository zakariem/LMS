...
namespace Library_Management_System
{
    public partial class viewBook : Form
    {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtbprice.Text = dataGridView1.CurrentRow.Cells[4].Value.ToString();
            txtbquantity.Text = dataGridView1.CurrentRow.Cells[5].Value.ToString();
        }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                using (SqlConnection conn = connectionClass.connect())
                {
                    SqlCommand cmd = new SqlCommand("update newBook set bName = @name, bAuthor = @author, bPubl = @publ, bPDate = @bpdate, bPrice = @bprice, bQuantity = @bquantity", conn);
                    ...
                    cmd.Parameters.AddWithValue("@bprice", Int64.Parse(txtbprice.Text));
